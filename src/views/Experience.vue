<template>
  <div class="side-page">
    ...
    <div class="card">
      ...
      <p class="margin-20">From a technical standpoint, I have gathered experience in full-stack web development [Frontend: React, Vue (TypeScript) | Backend: Node.js, Python] and application development [Flutter, React Native]. I've used AWS and Azure to distribute applications and manage data lakes, and I have experience working with data traditionally [Python, Pandas], and with machine learning tools [Python, Tensorflow, BERT] to large datasets.</p>

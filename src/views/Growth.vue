<template>
  <div class="side-page">
    ...
    <div class="card">
      ...
      <p class="margin-20">I am also exploring machine learning implementations because even though many of the tools have matured, I am excited to investigate new uses for existing open-source tools. In addition, while I am skeptical about the current implementations of blockchain technology, I am captivated by what a publicly provable ownership model will mean for the internet.</p>
